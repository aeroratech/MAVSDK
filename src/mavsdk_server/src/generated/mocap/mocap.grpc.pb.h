...
public:
    ...
    template<class BaseClass> class WithCallbackMethod_SetAttitudePositionMocap : public BaseClass {
    private:
        void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
    ...
    template<class BaseClass> class WithCallbackMethod_SetOdometry : public BaseClass {
    private:
        void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
    ...
    public:
        ...
        void
        SetMessageAllocatorFor_SetOdometry(::grpc::MessageAllocator<
                                           ::mavsdk::rpc::mocap::SetOdometryRequest,
        ...
        ~WithCallbackMethod_SetOdometry() override { BaseClassMustBeDerivedFromService(this); }
        // disable synchronous version of this method
        ::grpc::Status SetOdometry(
            ::grpc::ServerContext* /*context*/,
            const ::mavsdk::rpc::mocap::SetOdometryRequest* /*request*/,
    ...
    typedef WithCallbackMethod_SetVisionPositionEstimate<
        WithCallbackMethod_SetAttitudePositionMocap<WithCallbackMethod_SetOdometry<Service>>>
        CallbackService;
    ...
    template<class BaseClass> class WithRawCallbackMethod_SetOdometry : public BaseClass {
    private:
        void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
    ...
    public:
        ...
        ~WithRawCallbackMethod_SetOdometry() override { BaseClassMustBeDerivedFromService(this); }
        // disable synchronous version of this method
        ::grpc::Status SetOdometry(
            ::grpc::ServerContext* /*context*/,
            const ::mavsdk::rpc::mocap::SetOdometryRequest* /*request*/,
