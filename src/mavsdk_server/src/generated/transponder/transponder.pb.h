...
public:
    ...
    TransponderResult(TransponderResult&& from) noexcept : TransponderResult()
    {
        *this = ::std::move(from);
    }
...
public:
    ...
    AdsbVehicle(AdsbVehicle&& from) noexcept : AdsbVehicle() { *this = ::std::move(from); }
...
public:
    ...
    {}
    TransponderResponse(TransponderResponse&& from) noexcept : TransponderResponse()
    {
        *this = ::std::move(from);
    }
...
TransponderResponse::set_allocated_transponder(::mavsdk::rpc::transponder::AdsbVehicle* value)
{
    ...
    if (value != nullptr) {
        ::google::protobuf::Arena* submessage_arena =
            reinterpret_cast<::mavsdk::rpc::transponder::AdsbVehicle*>(value)->GetArena();
    ...
    ::mavsdk::rpc::transponder::TransponderResult* value)
{
    ...
    PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
    if (message_arena == nullptr) {
        delete reinterpret_cast<::mavsdk::rpc::transponder::TransponderResult*>(
            _impl_.transponder_result_);
    }

    if (value != nullptr) {
        ::google::protobuf::Arena* submessage_arena =
            reinterpret_cast<::mavsdk::rpc::transponder::TransponderResult*>(value)->GetArena();
        if (message_arena != submessage_arena) {
            value = ::google::protobuf::internal::GetOwnedMessage(
                message_arena, value, submessage_arena);
        }
