...
public:
    ...
    {}
    SetMavlinkTimeoutRequest(SetMavlinkTimeoutRequest&& from) noexcept : SetMavlinkTimeoutRequest()
    {
        *this = ::std::move(from);
    }
...
class ConnectionState final
    : public ::google::protobuf::
          Message /* @@protoc_insertion_point(class_definition:mavsdk.rpc.core.ConnectionState) */ {
public:
    ...
    ConnectionState(ConnectionState&& from) noexcept : ConnectionState()
    {
        *this = ::std::move(from);
    }
...
public:
    ...
    {}
    ConnectionStateResponse(ConnectionStateResponse&& from) noexcept : ConnectionStateResponse()
    {
        *this = ::std::move(from);
    }
...
ConnectionStateResponse::set_allocated_connection_state(::mavsdk::rpc::core::ConnectionState* value)
{
    ...
    if (value != nullptr) {
        ::google::protobuf::Arena* submessage_arena =
            reinterpret_cast<::mavsdk::rpc::core::ConnectionState*>(value)->GetArena();
