...
public:
    ...
    public:
        ...
        public:
            ...
            // Upload geofences.
            //
            // Polygon and Circular geofences are uploaded to a drone. Once uploaded, the geofence
            // will remain on the drone even if a connection is lost.
    ...
    template<class BaseClass> class WithCallbackMethod_ClearGeofence : public BaseClass {
    private:
        void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
    ...
    public:
        ...
        ~WithCallbackMethod_ClearGeofence() override { BaseClassMustBeDerivedFromService(this); }
        // disable synchronous version of this method
        ::grpc::Status ClearGeofence(
            ::grpc::ServerContext* /*context*/,
            const ::mavsdk::rpc::geofence::ClearGeofenceRequest* /*request*/,
    ...
    typedef WithCallbackMethod_UploadGeofence<WithCallbackMethod_ClearGeofence<Service>>
        CallbackService;
    ...
    template<class BaseClass> class WithRawCallbackMethod_ClearGeofence : public BaseClass {
    private:
        void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
    ...
    public:
        ...
        ~WithRawCallbackMethod_ClearGeofence() override { BaseClassMustBeDerivedFromService(this); }
        // disable synchronous version of this method
        ::grpc::Status ClearGeofence(
            ::grpc::ServerContext* /*context*/,
            const ::mavsdk::rpc::geofence::ClearGeofenceRequest* /*request*/,
