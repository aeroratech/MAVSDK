...
public:
    ...
    public:
        WithAsyncMethod_EraseAllLogFiles() { ::grpc::Service::MarkMethodAsync(2); }
    ...
    typedef WithAsyncMethod_GetEntries<
        WithAsyncMethod_SubscribeDownloadLogFile<WithAsyncMethod_EraseAllLogFiles<Service>>>
        AsyncService;
    template<class BaseClass> class WithCallbackMethod_GetEntries : public BaseClass {
    private:
        void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
    ...
    public:
        ...
        void
        SetMessageAllocatorFor_GetEntries(::grpc::MessageAllocator<
                                          ::mavsdk::rpc::log_files::GetEntriesRequest,
        ...
        ~WithCallbackMethod_GetEntries() override { BaseClassMustBeDerivedFromService(this); }
        // disable synchronous version of this method
        ::grpc::Status GetEntries(
            ::grpc::ServerContext* /*context*/,
            const ::mavsdk::rpc::log_files::GetEntriesRequest* /*request*/,
    ...
    template<class BaseClass> class WithCallbackMethod_SubscribeDownloadLogFile : public BaseClass {
    private:
        void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
    ...
    template<class BaseClass> class WithCallbackMethod_EraseAllLogFiles : public BaseClass {
    private:
        void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
    ...
    public:
        ...
        ~WithCallbackMethod_EraseAllLogFiles() override { BaseClassMustBeDerivedFromService(this); }
        // disable synchronous version of this method
        ::grpc::Status EraseAllLogFiles(
            ::grpc::ServerContext* /*context*/,
            const ::mavsdk::rpc::log_files::EraseAllLogFilesRequest* /*request*/,
    ...
    typedef WithCallbackMethod_GetEntries<
        WithCallbackMethod_SubscribeDownloadLogFile<WithCallbackMethod_EraseAllLogFiles<Service>>>
        CallbackService;
    ...
    public:
        WithGenericMethod_EraseAllLogFiles() { ::grpc::Service::MarkMethodGeneric(2); }
    ...
    public:
        WithRawMethod_EraseAllLogFiles() { ::grpc::Service::MarkMethodRaw(2); }
    ...
    template<class BaseClass> class WithRawCallbackMethod_GetEntries : public BaseClass {
    private:
        void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
    ...
    public:
        ...
        ~WithRawCallbackMethod_GetEntries() override { BaseClassMustBeDerivedFromService(this); }
        // disable synchronous version of this method
        ::grpc::Status GetEntries(
            ::grpc::ServerContext* /*context*/,
            const ::mavsdk::rpc::log_files::GetEntriesRequest* /*request*/,
    ...
    template<class BaseClass> class WithRawCallbackMethod_EraseAllLogFiles : public BaseClass {
    private:
        void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
    ...
    typedef WithStreamedUnaryMethod_GetEntries<WithStreamedUnaryMethod_EraseAllLogFiles<Service>>
    ...
    typedef WithStreamedUnaryMethod_GetEntries<WithSplitStreamingMethod_SubscribeDownloadLogFile<
        WithStreamedUnaryMethod_EraseAllLogFiles<Service>>>
        StreamedService;
};
