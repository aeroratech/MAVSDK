...
public:
    ...
    {}
    ManualControlResult(ManualControlResult&& from) noexcept : ManualControlResult()
    {
        *this = ::std::move(from);
    }
...
StartPositionControlResponse::_internal_mutable_manual_control_result()
{
    ...
    if (_impl_.manual_control_result_ == nullptr) {
        auto* p =
            CreateMaybeMessage<::mavsdk::rpc::manual_control::ManualControlResult>(GetArena());
        _impl_.manual_control_result_ =
    ...
    ::mavsdk::rpc::manual_control::ManualControlResult* value)
{
    ...
    if (message_arena == nullptr) {
        delete reinterpret_cast<::mavsdk::rpc::manual_control::ManualControlResult*>(
            _impl_.manual_control_result_);
    }
