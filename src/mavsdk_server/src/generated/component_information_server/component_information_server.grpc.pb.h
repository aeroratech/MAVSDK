...
public:
    ...
    typedef WithAsyncMethod_ProvideFloatParam<WithAsyncMethod_SubscribeFloatParam<Service>>
        AsyncService;
    template<class BaseClass> class WithCallbackMethod_ProvideFloatParam : public BaseClass {
    private:
        void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
    ...
    typedef WithCallbackMethod_ProvideFloatParam<WithCallbackMethod_SubscribeFloatParam<Service>>
        CallbackService;
    ...
    template<class BaseClass> class WithRawCallbackMethod_ProvideFloatParam : public BaseClass {
    private:
        void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
