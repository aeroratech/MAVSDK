...
public:
    ...
    typedef WithAsyncMethod_GetConfig<WithAsyncMethod_SetConfig<
        ...
        AsyncService;
    template<class BaseClass> class WithCallbackMethod_GetConfig : public BaseClass {
    private:
        void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
    ...
    public:
        ...
        void
        SetMessageAllocatorFor_GetConfig(::grpc::MessageAllocator<
                                         ::mavsdk::rpc::follow_me::GetConfigRequest,
    ...
    template<class BaseClass> class WithCallbackMethod_SetConfig : public BaseClass {
    private:
        void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
    ...
    public:
        ...
        void
        SetMessageAllocatorFor_SetConfig(::grpc::MessageAllocator<
                                         ::mavsdk::rpc::follow_me::SetConfigRequest,
        ...
        ~WithCallbackMethod_SetConfig() override { BaseClassMustBeDerivedFromService(this); }
        // disable synchronous version of this method
        ::grpc::Status SetConfig(
            ::grpc::ServerContext* /*context*/,
            const ::mavsdk::rpc::follow_me::SetConfigRequest* /*request*/,
    ...
    template<class BaseClass> class WithCallbackMethod_SetTargetLocation : public BaseClass {
    private:
        void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
    ...
    template<class BaseClass> class WithCallbackMethod_GetLastLocation : public BaseClass {
    private:
        void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
    ...
    public:
        ...
        ~WithCallbackMethod_GetLastLocation() override { BaseClassMustBeDerivedFromService(this); }
        // disable synchronous version of this method
        ::grpc::Status GetLastLocation(
            ::grpc::ServerContext* /*context*/,
            const ::mavsdk::rpc::follow_me::GetLastLocationRequest* /*request*/,
    ...
    typedef WithCallbackMethod_GetConfig<WithCallbackMethod_SetConfig<WithCallbackMethod_IsActive<
        WithCallbackMethod_SetTargetLocation<WithCallbackMethod_GetLastLocation<
            WithCallbackMethod_Start<WithCallbackMethod_Stop<Service>>>>>>>
        CallbackService;
    ...
    template<class BaseClass> class WithRawCallbackMethod_GetConfig : public BaseClass {
    private:
        void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
    ...
    template<class BaseClass> class WithRawCallbackMethod_SetConfig : public BaseClass {
    private:
        void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
    ...
    public:
        ...
        ~WithRawCallbackMethod_SetConfig() override { BaseClassMustBeDerivedFromService(this); }
        // disable synchronous version of this method
        ::grpc::Status SetConfig(
            ::grpc::ServerContext* /*context*/,
            const ::mavsdk::rpc::follow_me::SetConfigRequest* /*request*/,
    ...
    template<class BaseClass> class WithRawCallbackMethod_SetTargetLocation : public BaseClass {
    private:
        void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
    ...
    template<class BaseClass> class WithRawCallbackMethod_GetLastLocation : public BaseClass {
    private:
        void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
