...
public:
    ...
    InjectRequest(InjectRequest&& from) noexcept : InjectRequest() { *this = ::std::move(from); }
...
public:
    ...
    FailureResult(FailureResult&& from) noexcept : FailureResult() { *this = ::std::move(from); }
...
public:
    ...
    InjectResponse(InjectResponse&& from) noexcept : InjectResponse() { *this = ::std::move(from); }
...
InjectResponse::set_allocated_failure_result(::mavsdk::rpc::failure::FailureResult* value)
{
    ...
    if (value != nullptr) {
        ::google::protobuf::Arena* submessage_arena =
            reinterpret_cast<::mavsdk::rpc::failure::FailureResult*>(value)->GetArena();
